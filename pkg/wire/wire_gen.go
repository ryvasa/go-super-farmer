...
func InitializeApp() (*app.App, error) {
	...
	landCommodityUsecase := usecase_implementation.NewLandCommodityUsecase(landCommodityRepository, landRepository, cityRepository, commodityRepository, cacheCache)
