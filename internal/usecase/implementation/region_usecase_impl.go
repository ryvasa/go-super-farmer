...
type RegionUsecaseImpl struct {
	...
	provinceRepo repository_interface.ProvinceRepository
}

func NewRegionUsecase(regionRepo repository_interface.RegionRepository, cityRepo repository_interface.CityRepository, provinceRepo repository_interface.ProvinceRepository) usecase_interface.RegionUsecase {
