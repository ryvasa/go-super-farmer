...
type DemandUsecaseImpl struct {
	...
	demandHistoryRepo repository.DemandHistoryRepository
	commodityRepo     repository.CommodityRepository
	regionRepo        repository.RegionRepository
}

func NewDemandUsecase(demandRepo repository.DemandRepository, demandHistoryRepo repository.DemandHistoryRepository, commodityRepo repository.CommodityRepository, regionRepo repository.RegionRepository) DemandUsecase {
