...
func TestSaleHandler_CreateSale(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.Sale.EXPECT().CreateSale(gomock.Any(), gomock.Any()).Return(domain.Sale, utils.NewInternalError("internal error")).Times(1)
...
func TestSaleHandler_GetSaleByID(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.Sale.EXPECT().GetSaleByID(gomock.Any(), ids.SaleID).Return(nil, utils.NewInternalError("internal error")).Times(1)
...
func TestSaleHandler_UpdateSale(t *testing.T) {
	...
	t.Run("should return error when internal error", func(t *testing.T) {
		uc.Sale.EXPECT().UpdateSale(gomock.Any(), ids.SaleID, gomock.Any()).Return(nil, utils.NewInternalError("internal error")).Times(1)
...
func TestSaleHandler_DeleteSale(t *testing.T) {
	...
	t.Run("should return error when internal error", func(t *testing.T) {
		uc.Sale.EXPECT().DeleteSale(gomock.Any(), ids.SaleID).Return(utils.NewInternalError("internal error")).Times(1)
		req, _ := http.NewRequest(http.MethodDelete, "/sales/"+ids.SaleID.String(), nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
...
func TestSaleHandler_RestoreSale(t *testing.T) {
	...
	t.Run("should return error when internal error", func(t *testing.T) {
		uc.Sale.EXPECT().RestoreSale(gomock.Any(), ids.SaleID).Return(nil, utils.NewInternalError("internal error")).Times(1)
...
func TestSaleHandler_GetDeletedSaleByID(t *testing.T) {
	...
	t.Run("should return error when internal error", func(t *testing.T) {
		uc.Sale.EXPECT().GetDeletedSaleByID(gomock.Any(), ids.SaleID).Return(nil, utils.NewInternalError("internal error")).Times(1)
		req, _ := http.NewRequest(http.MethodGet, fmt.Sprintf("/sales/deleted/%s", ids.SaleID.String()), nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
