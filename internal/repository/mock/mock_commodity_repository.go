...
// Source: internal/repository/commodity_repository.go
...
func (mr *MockCommodityRepositoryMockRecorder) FindAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockCommodityRepository)(nil).FindAll), ctx)
}
