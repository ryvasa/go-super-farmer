...
func PriceRepositorySetup(t *testing.T) (*database.MockDB, repository_interface.PriceRepository, PriceRepositoryIDs, PriceRepositoryMockRows, PriceRepositoryMocDomain) {
...
func TestPriceRepository_Create(t *testing.T) {
	mockDB, repo, ids, _, domains := PriceRepositorySetup(t)
...
func TestPriceRepository_FindAll(t *testing.T) {
	mockDB, repo, ids, rows, _ := PriceRepositorySetup(t)
...
func TestPriceRepository_FindByRegionID(t *testing.T) {
	...
	t.Run("should return prices when find by region id successfully", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL1)).WithArgs(ids.RegionID).WillReturnRows(rows.Price)
	...
	t.Run("should return error when find by region id failed", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL1)).WithArgs(ids.RegionID).WillReturnError(errors.New("database error"))
		result, err := repo.FindByRegionID(context.TODO(), ids.RegionID)
		assert.Nil(t, result)
		assert.NotNil(t, err)
		assert.EqualError(t, err, "database error")
...
func TestPriceRepository_Delete(t *testing.T) {
	mockDB, repo, ids, _, _ := PriceRepositorySetup(t)
...
func TestPriceRepository_FindByCommodityIDAndRegionID(t *testing.T) {
	...
	t.Run("should return price when find by commodity id and region id successfully", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.CommodityID, ids.RegionID, 1).WillReturnRows(rows.Price)
	...
	t.Run("should return error when find by commodity id and region id not found", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.CommodityID, ids.RegionID, 1).WillReturnRows(rows.Notfound)
		result, err := repo.FindByCommodityIDAndRegionID(context.TODO(), ids.CommodityID, ids.RegionID)
		assert.Nil(t, result)
		assert.True(t, errors.Is(err, gorm.ErrRecordNotFound))
		assert.Nil(t, mockDB.Mock.ExpectationsWereMet())
