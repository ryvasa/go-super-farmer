...
func RegionRepositorySetup(t *testing.T) (*database.MockDB, repository_interface.RegionRepository, RegionRepositoryIDs, RegionRepositoryMockRows, RegionRepositoryMocDomain) {

	mockDB := database.NewMockDB(t)

	repo := repository_implementation.NewRegionRepository(mockDB.DB)
...
func TestRegionRepository_Create(t *testing.T) {
	mockDB, repo, ids, _, domains := RegionRepositorySetup(t)
...
func TestRegionRepository_FindByID(t *testing.T) {
	mockDB, repo, ids, rows, _ := RegionRepositorySetup(t)
	...
	t.Run("should return region when find by id successfully", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.RegionID, 1).WillReturnRows(rows.Region)
	...
	t.Run("should return error when find by id failed", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.RegionID, 1).WillReturnError(errors.New("database error"))
		result, err := repo.FindByID(context.TODO(), ids.RegionID)
		assert.Nil(t, result)
		assert.NotNil(t, err)
		assert.EqualError(t, err, "database error")
	...
	t.Run("should return error when find by id not found", func(t *testing.T) {
		...
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.RegionID, 1).WillReturnRows(region)
...
func TestRegionRepository_FindAll(t *testing.T) {
	...
	t.Run("should return regions when find all successfully", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WillReturnRows(rows.Region)
...
func TestRegionRepository_FindByProvinceID(t *testing.T) {
	...
	t.Run("should return regions when find by province id successfully", func(t *testing.T) {
		...
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.ProvinceID).WillReturnRows(rows.Region)
	...
	t.Run("should return error when find by province id failed", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.ProvinceID).WillReturnError(errors.New("database error"))
		result, err := repo.FindByProvinceID(context.TODO(), ids.ProvinceID)
		assert.Nil(t, result)
		assert.NotNil(t, err)
		assert.EqualError(t, err, "database error")
...
func TestRegionRepository_Delete(t *testing.T) {
	mockDB, repo, ids, _, _ := RegionRepositorySetup(t)
...
func TestRegionRepository_FindDeleted(t *testing.T) {
	...
	t.Run("should return error when find deleted by id failed", func(t *testing.T) {
		mockDB.Mock.ExpectQuery(regexp.QuoteMeta(expectedSQL)).WithArgs(ids.RegionID, 1).WillReturnError(gorm.ErrRecordNotFound)
		result, err := repo.FindDeleted(context.TODO(), ids.RegionID)
		assert.Nil(t, result)
