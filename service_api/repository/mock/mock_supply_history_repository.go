...
// Source: service_api/repository/interface/supply_history_repository_interface.go
...
func (m *MockSupplyHistoryRepository) FindByCityID(ctx context.Context, id int64) ([]*domain.SupplyHistory, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSupplyHistoryRepositoryMockRecorder) FindByCityID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByCityID", reflect.TypeOf((*MockSupplyHistoryRepository)(nil).FindByCityID), ctx, id)
}
...
func (m *MockSupplyHistoryRepository) FindByCommodityIDAndCityID(ctx context.Context, commodityID uuid.UUID, cityID int64) ([]*domain.SupplyHistory, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSupplyHistoryRepositoryMockRecorder) FindByCommodityIDAndCityID(ctx, commodityID, cityID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByCommodityIDAndCityID", reflect.TypeOf((*MockSupplyHistoryRepository)(nil).FindByCommodityIDAndCityID), ctx, commodityID, cityID)
}
