...
func TestProvinceHandler_CreateProvince(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().CreateProvince(gomock.Any(), gomock.Any()).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
...
func TestProvinceHandler_GetAllProvinces(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetAllProvinces(gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestProvinceHandler_GetProvinceByID(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetProvinceByID(gomock.Any(), ids.ProvinceID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestProvinceHandler_UpdateProvince(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().UpdateProvince(gomock.Any(), ids.ProvinceID, gomock.Any()).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
...
func TestProvinceHandler_DeleteProvince(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().DeleteProvince(gomock.Any(), ids.ProvinceID).Return(utils.NewInternalError("service_api server error")).Times(1)
