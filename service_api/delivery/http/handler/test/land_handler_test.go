...
func TestLandHandler_CreateLand(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		authUtil.EXPECT().GetAuthUserID(gomock.Any()).Return(ids.UserID, nil).Times(1)
		uc.EXPECT().CreateLand(gomock.Any(), ids.UserID, gomock.Any()).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
...
func TestLandHandler_GetOneLand(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetLandByID(gomock.Any(), ids.LandID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestLandHandler_GetOneLandByUserID(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetLandByUserID(gomock.Any(), ids.UserID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
		req, _ := http.NewRequest(http.MethodGet, "/lands/user/"+ids.UserID.String(), nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
...
func TestLandHandler_GetAllLands(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetAllLands(gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
		req, _ := http.NewRequest(http.MethodGet, "/lands", nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
...
func TestLandHandler_UpdateLand(t *testing.T) {
	...
	t.Run("should return error when bind error", func(t *testing.T) {
		authUtil.EXPECT().GetAuthUserID(gomock.Any()).Return(ids.UserID, nil).Times(1)
		uc.EXPECT().UpdateLand(gomock.Any(), ids.UserID, ids.LandID, gomock.Any()).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
...
func TestLandHandler_DeleteLand(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().DeleteLand(gomock.Any(), ids.LandID).Return(utils.NewInternalError("service_api error")).Times(1)
		...
		assert.Equal(t, "service_api error", response.Errors.Message)
		assert.Equal(t, response.Errors.Code, "INTERNAL_ERROR")
		assert.Equal(t, http.StatusInternalServerError, w.Code)
	})
...
func TestLandHandler_RestoreLand(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().RestoreLand(gomock.Any(), ids.LandID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
