...
func TestCityHandler_GetCityByID(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		uc.EXPECT().GetCityByID(gomock.Any(), ids.CityID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestCityHandler_UpdateCity(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		uc.EXPECT().UpdateCity(gomock.Any(), ids.CityID, gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestCityHandler_DeleteCity(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		uc.EXPECT().DeleteCity(gomock.Any(), ids.CityID).Return(utils.NewInternalError("service_api error")).Times(1)
