...
func TestLandCommodityHandler_CreateLandCommodity(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().CreateLandCommodity(gomock.Any(), gomock.Any()).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
...
func TestLandCommodityHandler_GetLandCommodityByID(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetLandCommodityByID(gomock.Any(), ids.LandCommodityID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
		req, _ := http.NewRequest(http.MethodGet, "/land_commodities/"+ids.LandCommodityID.String(), nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
...
func TestLandCommodityHandler_GetLandCommodityByLandID(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetLandCommodityByLandID(gomock.Any(), ids.LandID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestLandCommodityHandler_GetAllLandCommodity(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetAllLandCommodity(gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
		req, _ := http.NewRequest(http.MethodGet, "/land_commodities", nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
...
func TestLandCommodityHandler_GetLandCommodityByCommodityID(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().GetLandCommodityByCommodityID(gomock.Any(), ids.CommodityID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestLandCommodityHandler_UpdateLandCommodity(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().UpdateLandCommodity(gomock.Any(), ids.LandCommodityID, gomock.Any()).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
...
func TestLandCommodityHandler_DeleteLandCommodity(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().DeleteLandCommodity(gomock.Any(), ids.LandCommodityID).Return(utils.NewInternalError("service_api server error")).Times(1)
		req, _ := http.NewRequest(http.MethodDelete, "/land_commodities/"+ids.LandCommodityID.String(), nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
...
func TestLandCommodityHandler_RestoreLandCommodity(t *testing.T) {
	...
	t.Run("should return error when usecase error", func(t *testing.T) {
		uc.EXPECT().RestoreLandCommodity(gomock.Any(), ids.LandCommodityID).Return(nil, utils.NewInternalError("service_api server error")).Times(1)
		req, _ := http.NewRequest(http.MethodPatch, "/land_commodities/"+ids.LandCommodityID.String()+"/restore", nil)
		w := httptest.NewRecorder()
		r.ServeHTTP(w, req)
