...
func TestCommodityHandler_GetCommodityById(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		...
		uc.EXPECT().GetCommodityById(gomock.Any(), ids.CommodityID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestCommodityHandler_UpdateCommodity(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		...
		uc.EXPECT().UpdateCommodity(gomock.Any(), ids.CommodityID, gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestCommodityHandler_DeleteCommodity(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		...
		uc.EXPECT().DeleteCommodity(gomock.Any(), ids.CommodityID).Return(utils.NewInternalError("service_api error")).Times(1)
...
func TestCommodityHandler_RestoreCommodity(t *testing.T) {
	...
	t.Run("should return error when service_api error", func(t *testing.T) {
		...
		uc.EXPECT().RestoreCommodity(gomock.Any(), ids.CommodityID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
