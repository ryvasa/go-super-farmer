...
// Source: service_api/usecase/interface/commodity_usecase_interface.go
...
func (m *MockCommodityUsecase) GetAllCommodities(ctx context.Context, queryParams *dto.PaginationDTO) (*dto.PaginationResponseDTO, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllCommodities", ctx, queryParams)
...
func (mr *MockCommodityUsecaseMockRecorder) GetAllCommodities(ctx, queryParams interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllCommodities", reflect.TypeOf((*MockCommodityUsecase)(nil).GetAllCommodities), ctx, queryParams)
}
