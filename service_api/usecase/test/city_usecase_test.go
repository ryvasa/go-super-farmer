...
func TestCityUsecase_CreateCity(t *testing.T) {
	...
	t.Run("should return error when create city", func(t *testing.T) {
		repo.City.EXPECT().Create(ctx, gomock.Any()).Return(utils.NewInternalError("service_api error")).Times(1)
	...
	t.Run("should return error when find created city by id", func(t *testing.T) {
		...
		repo.City.EXPECT().FindByID(ctx, gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestCityUsecase_GetAllcities(t *testing.T) {
	...
	t.Run("should return error service_api error", func(t *testing.T) {
		repo.City.EXPECT().FindAll(ctx).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestCityUsecase_UpdateCity(t *testing.T) {
	...
	t.Run("should return error when update city", func(t *testing.T) {
		...
		repo.City.EXPECT().Update(ctx, ids.CityID, gomock.Any()).Return(utils.NewInternalError("service_api error")).Times(1)
...
func TestCityUsecase_DeleteCity(t *testing.T) {
	...
	t.Run("should return error when delete city", func(t *testing.T) {
		...
		repo.City.EXPECT().Delete(ctx, ids.CityID).Return(utils.NewInternalError("service_api error")).Times(1)
