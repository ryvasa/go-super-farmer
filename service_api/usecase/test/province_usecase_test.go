...
type ProvinceRepoMock struct {
	Province *mock_repo.MockProvinceRepository
}
...
func ProvinceUsecaseUtils(t *testing.T) (*ProvinceIDs, *ProvinceMocks, *ProvinceDTOMock, *ProvinceRepoMock, usecase_interface.ProvinceUsecase, context.Context) {
	...
	provinceRepo := mock_repo.NewMockProvinceRepository(ctrl)
...
func TestProvinceUsecase_CreateProvince(t *testing.T) {
	...
	t.Run("should return error when create province", func(t *testing.T) {
		repo.Province.EXPECT().Create(ctx, gomock.Any()).Return(utils.NewInternalError("service_api error")).Times(1)
	...
	t.Run("should return error when find created province by id", func(t *testing.T) {
		...
		repo.Province.EXPECT().FindByID(ctx, gomock.Any()).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestProvinceUsecase_GetAllProvinces(t *testing.T) {
	...
	t.Run("should return error service_api error", func(t *testing.T) {
		repo.Province.EXPECT().FindAll(ctx).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestProvinceUsecase_UpdateProvince(t *testing.T) {
	...
	t.Run("should return error when update province", func(t *testing.T) {
		...
		repo.Province.EXPECT().Update(ctx, ids.ProvinceID, gomock.Any()).Return(utils.NewInternalError("service_api error")).Times(1)
...
func TestProvinceUsecase_DeleteProvince(t *testing.T) {
	...
	t.Run("should return error when delete province", func(t *testing.T) {
		...
		repo.Province.EXPECT().Delete(ctx, ids.ProvinceID).Return(utils.NewInternalError("service_api error")).Times(1)
