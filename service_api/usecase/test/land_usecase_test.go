...
func TestLandUsecase_CreateLand(t *testing.T) {
	...
	t.Run("should return error service_api error", func(t *testing.T) {
		userID := uuid.New()
		repo.Land.EXPECT().Create(ctx, gomock.Any()).Return(utils.NewInternalError("service_api error")).Times(1)
	...
	t.Run("should return error when find created land ", func(t *testing.T) {
		...
		repo.Land.EXPECT().FindByID(ctx, ids.LandID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestLandUsecase_GetLandByUserID(t *testing.T) {
	...
	t.Run("should return error service_api error when find lands", func(t *testing.T) {
		repo.User.EXPECT().FindByID(ctx, ids.UserID).Return(mocks.User, nil).Times(1)
		repo.Land.EXPECT().FindByUserID(ctx, ids.UserID).Return(nil, utils.NewInternalError("service_api error")).Times(1)
...
func TestLandUsecase_GetAllLands(t *testing.T) {
	...
	t.Run("should return error service_api error", func(t *testing.T) {
		repo.Land.EXPECT().FindAll(ctx).Return(nil, errors.New("service_api error")).Times(1)
...
func TestLandUsecase_UpdateLand(t *testing.T) {
	...
	t.Run("should return error service_api error on update", func(t *testing.T) {
		repo.Land.EXPECT().FindByID(ctx, ids.LandID).Return(mocks.Land, nil).Times(1)

		repo.Land.EXPECT().Update(ctx, ids.LandID, mocks.Land).Return(utils.NewInternalError("service_api error")).Times(1)
	...
	t.Run("should return error service_api error when find updated land", func(t *testing.T) {
		// Setup ekspektasi
		repo.Land.EXPECT().FindByID(ctx, ids.LandID).Return(mocks.Land, nil).Times(1)
...
func TestLandUsecase_DeleteLand(t *testing.T) {
	...
	t.Run("should return error service_api error", func(t *testing.T) {
		repo.Land.EXPECT().FindByID(ctx, ids.LandID).Return(mocks.Land, nil).Times(1)
		repo.Land.EXPECT().Delete(ctx, ids.LandID).Return(utils.NewInternalError("service_api error")).Times(1)
...
func TestLandUsecase_RestoreLand(t *testing.T) {
	...
	t.Run("Test RestoreLand service_api error", func(t *testing.T) {

		repo.Land.EXPECT().FindDeletedByID(ctx, ids.LandID).Return(mocks.Land, nil).Times(1)

		repo.Land.EXPECT().Restore(ctx, ids.LandID).Return(errors.New("service_api error")).Times(1)
